...
class StorieBed(models.Model):
    ...
    user_id = models.ForeignKey(User, on_delete=models.CACADE) # Unsure if I want to do this (deletes all projects if user is deleted). Perhaps better to save projects?
